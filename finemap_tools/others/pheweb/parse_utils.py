...
default_field_aliases: ty.Dict[str, str] = {
    field_name.lower(): field_name.lower() for field_name in fields
}
for field_name, field_dict in fields.items():
